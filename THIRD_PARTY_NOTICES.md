...
Native MCP Sandbox Phases 1 and 2 depend on nlohmann/json 3.11 or newer, supplied by
the host operating system. Dependency source is not vendored in this repository.
